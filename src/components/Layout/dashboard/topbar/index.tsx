      ...
      <div className="flex justify-between items-center">
        ...
        {!isLoggedIn && (
          <div className="hidden lg:flex  items-center justify-end gap-x-4">
            <button
              className="rounded-full py-[16px] w-[190px] bg-[#141922]  text-xs font-semibold outline-none focus:outline-none"
              onClick={() => navigate("/login")}
            >
              LOG IN
            </button>
            <button
              className="rounded-full py-[16px] md:px-6 w-[190px] bg-s-gradient text-xs font-semibold outline-none focus:outline-none"
