                ...
                <>
                  {/* onClick={() => (user ? navigate("/" + user.accountDomain) : null)}  */}
                    ...
                    <div className="flex items-start justify-between py-3 px-4">
                      <p className="text-[12px] text-muted font-[600]">Total Balance:</p>
                      ...
                      <div className="py-3 px-4 bg-dark-700 text-[12px]" style={{ borderTop: "2px solid rgba(83, 96, 121, 0.2)" }} onClick={() => (user ? navigate("/" + user.accountDomain) : null)} >View my profile</div>
                      <div className="py-3 px-4 bg-dark-700 text-[12px]" style={{ borderTop: "2px solid rgba(83, 96, 121, 0.2)" }}>Edit profile</div>
                      <div className="py-3 px-4 bg-dark-700 text-[12px]" style={{ borderTop: "2px solid rgba(83, 96, 121, 0.2)" }}>My wallet</div>
                      <div className="py-3 px-4 bg-dark-700 text-[12px]" style={{ borderTop: "2px solid rgba(83, 96, 121, 0.2)" }}>Log out</div>
                  </div>
                </>
              )}
          </div>
