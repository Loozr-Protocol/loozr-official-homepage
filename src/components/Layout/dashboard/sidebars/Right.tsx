...
export default function Right() {
  ...
  return (
    <>
      <div className="bg-dark-900 !flex flex-col items-start justify-between h-screen gap-6 py-2 hidden lg:ml-4 md:hidden lg:block lg:pr-10 md:pr-12 md:pl-6 xl:pr-[100px] xl:pl-3 pb-12 mb-5" style={{ width: xl ? `${drawerMaxWidth}vw` : md ? "300px" : 0, }}>
