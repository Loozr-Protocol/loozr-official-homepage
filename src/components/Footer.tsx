      ...
      <footer className=" w-full !bg-[#11151D] relative px-6 lg:px-20 z-30 pb-0">
        <div className=" w-full grid grid-cols-1 lg:grid-cols-4 gap-12 pb-4 !pt-12" >
          <div className=" w-full " >
            ...
            <p className=" font-medium mt-6 text-base txt text-[#fff] " >Social music streaming and DeFi platform for creators and music lovers. </p>
          </div>
          <div className=" w-full flex flex-col lg:items-start  " > 
            <p className=" font-bold text-white text-lg lg:h-10 " >COMPANY</p>
            <div className=" font-medium mt-3 lg:mt-6 text-sm txt text-[#fff]  " >
              <div className=" flex items-center mt-2 " >
                <div className="w-fit" >
                  <div className=" w-1 h-1 rounded-full bg-[#fff] mr-3 " />
                </div>
                 <p className=" font-medium text-sm txt text-[#fff]  " >Loozr Products </p>
              </div>
              <div className=" flex items-center mt-2 " >
                <div className="w-fit" >
                  <div className=" w-1 h-1 rounded-full bg-[#fff] mr-3 " />
                </div>
                 <p className=" font-medium text-sm txt text-[#fff]  " >Loozr Ecosystem  </p>
              </div>
              <div className=" flex items-center mt-2 " >
                <div className="w-fit" >
                  <div className=" w-1 h-1 rounded-full bg-[#fff] mr-3 " />
                </div>
                 <p className=" font-medium text-sm txt text-[#fff]  " >Loozr Features</p>
              </div>
            </div>
          </div> 
          <div className=" w-full hidden lg:flex flex-col items-start  " > 
            <p className=" font-bold text-white text-lg h-10 " >QUICK LINKS</p>
            <div className=" font-medium mt-6 text-sm txt text-[#fff]  " >
              <div className=" flex items-center mt-2 " >
                <div className="w-fit" >
                  <div className=" w-1 h-1 rounded-full bg-[#fff] mr-3 " />
                </div>
                 <p className=" font-medium text-sm txt text-[#fff]  " >Launch Testnet</p>
              </div>
              <div className=" flex items-center mt-2 " >
                <div className="w-fit" >
                  <div className=" w-1 h-1 rounded-full bg-[#fff] mr-3 " />
                </div>
                 <p className=" font-medium text-sm txt text-[#fff]  " >LiteDOC</p>
              </div>
              <div className=" flex items-center mt-2 " >
                <div className="w-fit" >
                  <div className=" w-1 h-1 rounded-full bg-[#fff] mr-3 " />
                </div>
                 <p className=" font-medium text-sm txt text-[#fff]  " >Tokenomics</p>
              </div>
              <div className=" flex items-center mt-2 " >
                <div className="w-fit" >
                  <div className=" w-1 h-1 rounded-full bg-[#fff] mr-3 " />
                </div>
                 <p className=" font-medium text-sm txt text-[#fff]  " >Roadmap</p>
              </div>
              <div className=" flex items-center mt-2 " >
                <div className="w-fit" >
                  <div className=" w-1 h-1 rounded-full bg-[#fff] mr-3 " />
                </div>
                 <p className=" font-medium text-sm txt text-[#fff]  " >Contributors</p>
              </div>
              <div className=" flex items-center mt-2 " >
                <div className="w-fit" >
                  <div className=" w-1 h-1 rounded-full bg-[#fff] mr-3 " />
                </div>
                 <p className=" font-medium text-sm txt text-[#fff]  " >FAQ</p>
              </div>
            </div>
          </div> 
          <div className=" w-full hidden lg:flex flex-col items-start " > 
            ...
            <div className=" font-medium mt-6 text-sm txt text-[#fff]  " >
              <div className=" flex items-center mt-2 " >
                <div className="w-fit" >
                 ...
                 <a href="#" className=" font-medium text-sm txt text-[#fff]  " > Twitter </a>
              </div>
              <div className=" flex items-center mt-2 " >
                <div className="w-fit" >
                  <div className=" w-1 h-1 rounded-full bg-[#fff] mr-3 " />
                </div>
                 <a href="#" className=" font-medium text-sm txt text-[#fff]  " > Discord  </a>
              </div>
              <div className=" flex items-center mt-2 " >
                <div className="w-fit" >
                  <div className=" w-1 h-1 rounded-full bg-[#fff] mr-3 " />
                </div>
                 <a href="#" className=" font-medium text-sm txt text-[#fff]  " > Telegram</a>
              </div>
              <div className=" flex items-center mt-2 " >
                <div className="w-fit" >
                  <div className=" w-1 h-1 rounded-full bg-[#fff] mr-3 " />
                </div>
                 <a href="#" className=" font-medium text-sm txt text-[#fff]  " > Medium </a>
              </div>
              <div className=" flex items-center mt-2 " >
                <div className="w-fit" >
                  <div className=" w-1 h-1 rounded-full bg-[#fff] mr-3 " />
                </div>
                 <a href="#" className=" font-medium text-sm txt text-[#fff]  " > Instagram  </a>
              </div>
              <div className=" flex items-center mt-2 " >
                <div className="w-fit" >
                  <div className=" w-1 h-1 rounded-full bg-[#fff] mr-3 " />
                </div>
                 <a href="#" className=" font-medium text-sm txt text-[#fff]  " > Tiktok</a>
              </div>
            </div>
          </div>
        </div>
        <div className=" flex items-start lg:my-0 my-4 " >
          <div className=" w-8 h-8 rounded-full border border-[#fff] flex justify-center items-start " >
        ...
        <div className=" w-full border-t border-[#536079] mt-4 py-4 lg:flex-row flex-col flex lg:justify-between  "  >
          <p className=" font-medium !text-sm txt text-[#fff]  " >© 2023 Loozr - All Rights Reserved.</p>
          <div className=" flex lg:flex-row flex-col lg:mt-0 mt-2 lg:items-start gap-2 lg:gap-5 " >
            <p className=" font-medium !text-sm txt text-[#fff]  " >Cookie policy</p>
            <p className=" font-medium !text-sm txt text-[#fff]  " >Privacy policy</p>
            <p className=" font-medium !text-sm txt text-[#fff]  " >Terms of service</p>
          </div>
        </div>
