  ...
  let slides = [
    ...
    <div className=" w-full flex flex-col !bg-[#0c0f15] items-center" > 
      ...
      <div className=" py-8 w-full flex flex-col items-center " >  
        <div  className=" relative max-w-3xl z-50 " > 
          <p  id="gradenttext"  className=" font-bold text-2xl text-left  ">For Music Creators</p>  
          <div className=" w-full py-2 mt-6 px-1 " >
            <div className=" flex text-white font-medium " >
              <div className=" w-fit " > 
                <div className=" w-[4px] h-[4px] mt-[12px]  bg-white rounded-full mr-2 " />
              </div>
        ...
        <div className="w-full flex items-center relative lg:px-24 mb-12 ">
          ...
          <div className=" w-full relative pt-14 sec-head " > 
            <span className="tbg  ">BUILDING</span>
              <p className=" font-medium text-lg mx-auto txt text-white lg:max-w-md " >Open web democratizing music industry participation, investible talents, community-driven ownership, better monetization, incentivized social interactions, and growth.</p>
          </div>
        </div>    
