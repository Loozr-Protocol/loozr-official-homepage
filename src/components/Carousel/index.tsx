...
const Carousel = () => {
  ...
  const paneNodes = Array.apply(null, Array(numberOfSlides)).map((_, i) => {
    return (
      <div
        key={i}
        className="w-full  min-h-[240px] bg-no-repeat bg-cover bg-center pl-8 py-7 flex flex-col justify-end mb-7 relative"
      ...
      >
        ...
        <p className="text-white font-bold text-xl max-w-[300px]">
