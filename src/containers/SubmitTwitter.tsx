...
export default function SubmitTwitter() {
    ...
    const handleLogin = () => {
        window.location.href = 'https://api.loozr.io/api/users/twitter-callback/';
    };
    ...
    return (
        <div className=' w-full flex justify-center items-center' >
            <div className='max-w-[700px] px-6 md:px-36 mx-0 md:mx-10 flex justify-center flex-col items-center py-24'>
                ...
                <button onClick={() => handleLogin()} className="mt-12 text-white disabled:text-muted font-medium text-base rounded-[12px] bg-gradient-ld disabled:bg-dark-800 mb-11 w-full md:w-[230px] focus:outline-none h-[48px]">
